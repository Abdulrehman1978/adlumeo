...
export const services: ServiceCategory[] = [
  {
    ...
    description:
      "Transform your social profiles from quiet placeholders into active, consistent brand destinations. We build your monthly content schedule, manage ongoing community interactions, maintain visual consistency, and deliver clear reporting so you always know how your channels are performing.",
    deliverables: [
      ...
      "Regular community engagement and inbound comment/DM response routing",
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Ongoing optimization and transparent performance and spend reporting",
    ],
  ...
  },
  {
    ...
    deliverables: [
      ...
      "Regular strategic growth reviews and channel expansion planning",
